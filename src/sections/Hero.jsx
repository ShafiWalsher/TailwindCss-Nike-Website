  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl mx-sm:text-[72] max-sm:leading-[82] font-bold">
          <span className="xl:bg-white xl:rounded-r-2xl xl:whitespace-nowrap relative z-10 pr-10">The New Arrival</span>
          <br />
      ...
      <div className="rounded-2xl shadow-3xl relative flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
